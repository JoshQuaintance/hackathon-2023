...
class GS1DigitalLinkToolkit {
    ...
    fixedLengthTable = { "00": 20, "01": 16, "02": 16, "03": 16, "04": 18, "11": 8, "12": 8, "13": 8, "14": 8, "15": 8, "16": 8, "17": 8, "18": 8, "19": 4, "20": 4, "31": 10, "32": 10, "33": 10, "34": 10, "35": 10, "36": 10, "41": 16 };
    ...
    extractFromGS1digitalLink(gs1DigitalLinkURI) {
        ...
        let candidates = {};
        for (const pathCandidate of Object.keys(pathCandidates))
            candidates[pathCandidate] = pathCandidates[pathCandidate]

        for (const qSC of Object.keys(queryStringCandidates))
            candidates[qSC] = queryStringCandidates[qSC];
